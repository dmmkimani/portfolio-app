...
@section('content')
    ...
    <div style="margin-top: 75px;">
        ...
        <p class="violet">I have an </p><p class="gold">MSc in Advanced Computer Science with Distinction </p><p class="violet">and</p><br>
        <p class="violet">I am always eager to </p><p class="gold">apply my skills </p><p class="violet">and </p><p class="gold">continuously learn </p><p class="violet">in a </p><p class="gold">professional environment</p><p class="violet">.</p>
    </div>
